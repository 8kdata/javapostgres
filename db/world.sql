CREATE USER worlduser WITH PASSWORD 'HahodOid3' REPLICATION;

CREATE DATABASE world OWNER worlduser;
\c world
...
ALTER TABLE city OWNER TO worlduser;
ALTER TABLE country OWNER TO worlduser;
ALTER TABLE countrylanguage OWNER TO worlduser;
